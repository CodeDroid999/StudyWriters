...
function LightCustomNavbar() {
  ...
  return (
    <div className="fixed left-0 top-0 z-20 w-full  border-1 border-x-transparent bg-gray-100 duration-300 ease-in">
            ...
            <div className="rounded-full p-3 text-white ">
              {!user ? (
                ...
                <div className="flex flex-row items-center space-x-1">
                  ...
                  <div className="flex">
                    {userRole === 'Student' && (
                      <Link href="/browse-assignments" className=" text-gray-900 hover:text-green-500 text-sm">
                        Browse
                      </Link>
                    )}
                    {userRole === 'Tutor' && (
                      <Link
                        href="/boost-earnings"
                        className="text-gray-900 hover:text-green-500 text-sm whitespace-nowrap"
                        id="customfontsize"
                      >
                        Boost Earnings
                      </Link>
                  ...
                  <div className="flex">
                    {userRole === 'Student' && (
                      <Link href="/post-assignment" className=" text-gray-900 hover:text-green-500 text-sm">
                        Post
                      </Link>
                    )}
                    {userRole === 'Tutor' && (
                  ...
                  <div className="flex">
                    {userRole === 'Student' && (
                      <Link href={`/my-assignments/${user.userId}`} className="text-gray-900  hover:text-green-500 text-sm">
                        Assignments
                      </Link>
                    )}
                    ...
                    {userRole === 'Tutor' && (
                      <Link
                        ...
                        className="text-gray-900 hover:text-green-500 text-sm"
                        style={{ whiteSpace: 'nowrap' }}
                        id="customfontsize"
                      >My Orders
                      </Link>
          ...
          {!user ? (
            ...
            <div className="flex flex-row items-center space-x-1">
              ...
              <div className="flex flex-row hover:bg-gray-100 p-1 rounded">
                {userRole === 'Student' && (
                  <Link href="/browse-assignments" className="text-gray-900 hover:text-green-500">
                    Browse
                  </Link>
                )}

                {userRole === 'Tutor' && (
                  <Link href="/boost-earnings" className="text-gray-900 hover:text-green-500 whitespace-nowrap">
                    Boost Earnings
                  </Link>
                )}
              </div>
              <div className="flex flex-row hover:bg-gray-100 p-1 rounded">
                {userRole === 'Student' && (
                  <Link href="/post-assignment" className="text-gray-900 hover:text-green-500">
                    Post
                  </Link>
                )}

                {userRole === 'Tutor' && (
                  <Link href="/bid-assignments" className="text-gray-900 hover:text-green-500 whitespace-nowrap">
                    Bid
                  </Link>
                )}
              </div>
              <div className="flex flex-row hover:bg-gray-100 p-1 rounded">
                {userRole === 'Student' && (
                  <Link href={`/my-assignments/${user.userId}`} className="text-gray-900 hover:text-green-500">
                    Assignments
                  </Link>
                )}

                {userRole === 'Tutor' && (
                  <Link href={`/orders/${user.userId}`} className="text-gray-900 hover:text-green-500 whitespace-nowrap">
                    My Orders
                  </Link>
                )}
              </div>
              ...
              <div className="flex flex-row hover:bg-gray-100 p-1 rounded">
                <Link href={`/alerts/${user.userId}`} className="text-gray-900 hover:text-green-500">
                  <Image
                    src="https://i.postimg.cc/25LMy016/alert-icon-removebg-preview.png"
                    alt="assignment" width="200" height="200"
                    className="h-[25px] w-[100%]"
