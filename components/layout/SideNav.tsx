...
const SideNav = () => {
  return (
    <>
      ...
      <div className="p-2 flex font-bold items-center">
        <Link href="/privacy" className="text-blue-400 text-right whitespace-nowrap">Privacy</Link>
      </div>
      <div className="p-2 flex font-bold items-center">
        <Link href="/terms" className="text-blue-400 text-right whitespace-nowrap">Terms</Link>
      </div>
      <div className="p-2 flex font-bold items-center">
        <Link href="/refund" className="text-blue-400 text-right whitespace-nowrap">Refund</Link>
      </div>
      <div className="p-2 flex font-bold items-center">
        <Link href="/refer-a-friend" className="text-blue-400 text-right whitespace-nowrap">Refer a Friend</Link>
      </div>
      <div className="p-2 flex font-bold items-center">
