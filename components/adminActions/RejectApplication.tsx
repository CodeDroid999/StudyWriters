...
export default function RejectApplication({ applicationId }) {
    const [isFormOpen, setIsFormOpen] = useState(false)
    const RejectAssessment = async () => {
        try {
            const docRef = doc(db, 'applications', applicationId);
            await updateDoc(docRef, { applicationStatus: 'Rejected' });
            ...
            {isFormOpen && (
               ...
               flex-row justify-between`}
                        ...
                        <div className="mb-10 mt-5 text-base font-medium text-black">
                            <p>Are you sure you want to reject the ID documents?</p>
                        </div>
