...
export default function MakeOffer({ posterId, taskTitle, poster }) {
  ...
  const { serviceFee, finalPrice } = calculateFinalPrice(offer)
  const charactersRemaining = 1500 - proposal.length
  return (
    <div className="relative">
      ...
      {confirmPopup && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-3 ">
          <div className=" min-h-[400px] w-full max-w-[400px] rounded-lg bg-white px-6 pb-3 pt-5 shadow-2xl">
            <ConfirmProfile
          ...
          <div className="min-h-[400px] w-full max-w-[400px] rounded-lg bg-white p-4 shadow-2xl">
            ...
            {step === 1 && (
              <div className="flex flex-col items-center gap-2 pt-8">
                ...
                <button
                  onClick={goToStep2}
                  className="mt-16 w-full rounded-full bg-green-500 py-2 font-semibold text-white"
                >
                  Next
                </button>
              </div>
            ...
            {step === 3 && (
              <div className="flex h-full flex-col">
                    ...
                    <div className="flex flex-row items-center">
                      ...
                      <div className="ml-3 flex-1">
                        ...
                        <p className="text-xs font-medium text-gray-700">
                          Task funds are held securely until the task is
                          completed.
                        </p>
                      </div>
                    </div>
                ...
                <button
                  onClick={SubmitForm}
                  className="mt-10 w-full rounded-full bg-green-500 py-2 font-semibold text-white"
                >
                  Submit offer
                </button>
              </div>
