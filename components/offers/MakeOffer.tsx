          ...
          <div className="min-h-[400px] w-full max-w-[400px] rounded-lg bg-white p-4 shadow-2xl">
            ...
            {step === 1 && (
              <div className="flex flex-col items-center gap-2 pt-8">
                ...
                <button
                  onClick={goToStep2}
                  className="mt-16 w-full rounded-full bg-green-600 py-2 font-semibold text-white"
                >
                  Next
                </button>
              </div>
            ...
            {step === 2 && (
              <div className="flex flex-col pt-8">
                ...
                <button
                  onClick={goToStep3}
                  className="mt-2 w-full rounded-full bg-green-600 py-2 font-semibold text-white"
                >
                  Next
                </button>
              </div>
