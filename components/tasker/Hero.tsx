...
export default function Hero() {
  ...
  return (
    <div className="my-4 flex flex-col-reverse  rounded-3xl bg-green-500 px-3 py-8 sm:px-4 sm:py-16  md:flex-row  md:px-8 xl:my-10 xl:px-36  xl:py-20">
